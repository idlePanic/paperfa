...
<div class="app-content content container-fluid">
    <div class="content-wrapper">
        ...
        <div class="content-header row">
                <div class="float-left"><h1>لیست دسته ها</h1></div>
                <div class="pull-left"><a  href="{{asset('/admin/add-category')}}"><button class="btn btn-primary">افزودن دسته</button></a></div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    <table id="example" class="display" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <th>شناسه</th>
                                            <th>نام دسته فارسی</th>
                                            <th>نام دسته انگلیسی</th>
                                        </tr>
                                        </thead>
                                        <tfoot>
                                        <tr>
